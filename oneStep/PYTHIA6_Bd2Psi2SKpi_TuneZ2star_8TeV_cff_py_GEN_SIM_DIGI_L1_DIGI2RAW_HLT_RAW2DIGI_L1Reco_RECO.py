...
# with command line options: Configuration/GenProduction/python/PYTHIA6_Bd2Psi2SKpi_TuneZ2star_8TeV_cff.py --step GEN,SIM,DIGI,L1,DIGI2RAW,HLT:7E33v2,RAW2DIGI,L1Reco,RECO --beamspot Realistic8TeVCollision --conditions START53_V19F::All --pileup NoPileUp --datamix NODATAMIXER --eventcontent RECOSIM --datatier GEN-SIM-RECO --no_exec -n 1000
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('B+ -> Psi(2S)K+pi- at 8TeV'),
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PYTHIA6_Bd2Psi2SKpi_TuneZ2star_8TeV_cff_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT_RAW2DIGI_L1Reco_RECO.root'),
...
process.decayfilter = cms.EDFilter("PythiaDauVFilter",
    ...
    MaxEta = cms.untracked.vdouble(9999.0, 2.5, 2.5),
    MinEta = cms.untracked.vdouble(-9999.0, -2.5, -2.5),
