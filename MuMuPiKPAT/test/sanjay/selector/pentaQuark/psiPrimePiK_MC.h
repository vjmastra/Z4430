...
public :
   ...
   Bool_t MC, officialMC, oldNtuple, priVtxsInfo, priVtx3D, Kai_cuts, HLT_Displaced, fixedMassWind, sideband ;
   ...
   */
   ...
   // HLT8_Jpsi
   TH1F* myInclusiveMuMuMass_HLT_8_Jpsi ;
   //
   // HLT0_v*
   ...
   TH1F* hPionfromB_pt, *hKaonfromB_pt, *hPionFromKstar_pT, *hKaonFromKstar_pT, *hPionFromKstar_ex_pT, *hKaonFromKstar_ex_pT, *hPionFromKstar_sb_pT, *hKaonFromKstar_sb_pT ;
   TH1F* exclMuMuKPiMassSel, *hmyPsiPKPiMass_bothCombSel ;
   ...
   TH1F* hmyKPiMass, *hmyKPiMass_ex, *hmyKPiMass_KpTcut, *hmyKPiMass_ex_KpTcut, *hmyKPiMass_sb, *hmyMuMuPiMass ;
   ...
   TH1F* hPionfromB_p_1B0, *hKaonfromB_p_1B0, *hPionfromB_pt_1B0, *hKaonfromB_pt_1B0 ;
   TH2F* kaonP_vs_pionP_1B0, *kaonPt_vs_pionPt_1B0 ;
   TH2F* dEdx_vs_p_1B0, *dEdx_vs_pT_1B0 ;
   ...
   Double_t muon_mass, phi_mass, jpsi_mass, psi2S_mass, pionCh_mass, kaonCh_mass, proton_mass, B0_mass;
...
void psiPrimePiK_MC::Init(TTree *tree)
{
  ...
  priVtx3D = kTRUE ; priVtx3D = kFALSE ;
