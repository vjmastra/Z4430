...
void psiPrimePiK_MC::SlaveBegin(TTree * /*tree*/)
{
   ...
   if ( MC ) {
	 ...
	 if (!newSoftMuonID) {
	   if (!only1psiPrime) {
	     if (!fixedMassWind)
	       OutFile = new TProofOutputFile( "pentaQuark.root" );
  ...
  // put them here:
  //
  Float_t MuMuMass_low = 3., MuMuMass_high = 4. ;  Int_t MuMuMass_bins = 200 ;
  ...
  myInclusiveMuMuMass_noTrigg = new TH1F("myInclusiveMuMuMass_noTrigg","myInclusiveMuMuMass noTrigg",220,2.8,3.9);
  // HLT_8_Jpsi_v*
  myInclusiveMuMuMass_HLT_8_Jpsi = new TH1F("myInclusiveMuMuMass_HLT_8_Jpsi","myInclusiveMuMuMass HLT8 J/#psi",220,2.8,3.9);
  // HLT_0_v*
  ...
  // K* plots
  exclusiveMuMuKPiMass = new TH1F("exclusiveMuMuKPiMass","MuMuKPiMass with HLT8 and nB^{0}>0 BEFORE selection", 200, 4.6, 6.6);
  ...
  //
  hmyPsiPKPiMassBaseSelAlt = new TH1F("myPsiPKPiMassBaseSelAlt","myPsiPKPiMassSel BASELINE ALTERNATIVE", 220, 4.6, 9.0);
  hPsiPrimefromBMassSel = new TH1F("PsiPrimefromBMassSel","PsiPrimefromBMassSel", 100, 3.45, 3.9); 
  hmyPsiPMassSel = new TH1F("myPsiPMassSel","myPsiPMassSel;m(#mu^{+}#mu^{-}) [GeV]", 500, 2.9, 3.9); 
  hmyPsiPKPiMassSelAlt = new TH1F("myPsiPKPiMassSelAlt","myPsiPKPiMassSel ALTERNATIVE", 300, 4.8, 7.8); 
  ...
  psi2SPiSqMass_vs_KPiSqMass_AC = new TH2F("reco_psi2SPi_vs_KPi_dalitz_AC","#psi'#pi^{-} vs K^{+}#pi^{-} reco;m^{2}(K^{+}#pi^{-});m^{2}(#psi'#pi^{-})", 15*2,0.,3., 24*2,13.,25.) ;
  // tight cuts
  // single
  ...
  hmyPsiPKPiMass_bothComb = new TH1F("myPsiPKPiMass_bothComb","myPsiPKPiMass both tracks combination", 220, 4.6, 6.8); //check
  //
  hB0VtxCL = new TH1F("B0VtxCL","B0VtxCL", 200, 0., 1.);
  hB0_Pt = new TH1F("B0_pT","B^{0} p_{T};p_{T} [GeV]", 100, 0., 30.);
  //
  ...
  hPionfromB_pt = new TH1F("PionfromB_pT","#pi^{-} from B^{0};p_{T} [GeV]", 200,0.,10.);
  hKaonfromB_pt = new TH1F("KaonfromB_pT","K^{+} from B^{0};p_{T} [GeV]", 200,0.,10.);
  ...
  // high purity
  hmyKPiMass_KpTcut = new TH1F("myKPiMass_KpTcut","K* with p_{T}(K^{+}) < 1 GeV;m(K^{+}#pi^{-}) [GeV]", 110,1.4,2.5) ;
  hmyKPiMass_ex_KpTcut = new TH1F("myKPiMass_ex_KpTcut","K* exchanged with p_{T}(K^{+}) < 1 GeV;m(K^{+}#pi^{-}) [GeV]", 110,1.4,2.5) ;
  hmyKPiMass_KpTcut_tightTr = new TH1F("myKPiMass_KpTcut_tightTr","K* with p_{T}(K^{+}) < 1 GeV (tight tracks);m(K^{+}#pi^{-}) [GeV]", 110,1.4,2.5) ;
  hmyKPiMass_ex_KpTcut_tightTr = new TH1F("myKPiMass_ex_KpTcut_tightTr","K* exchanged with p_{T}(K^{+}) < 1 GeV (tight tracks);m(K^{+}#pi^{-}) [GeV]", 110,1.4,2.5) ;
  hmyKPiMass_KpTcut_HP = new TH1F("myKPiMass_KpTcut_HPTr","K* with p_{T}(K^{+}) < 1 GeV (HP tracks);m(K^{+}#pi^{-}) [GeV]", 110,1.4,2.5) ;
  hmyKPiMass_ex_KpTcut_HP = new TH1F("myKPiMass_ex_KpTcut_HPTr","K* exchanged with p_{T}(K^{+}) < 1 GeV (HP tracks);m(K^{+}#pi^{-}) [GeV]", 110,1.4,2.5) ;
  //
  ...
  hpsiPK_vs_KPi = new TH2F("psiPK_vs_KPi","m(#psi'K^{+}) vs m(K^{+}#pi^{-}) from K*;m(K^{+}#pi^{-}) [GeV];m(#psi'K^{+}) [GeV]", 110,1.4,2.5, 200,3.6,6.) ;
  hpsiPK_vs_KPi_ex = new TH2F("psiPK_vs_KPi_ex","m(#psi'K^{+}) vs m(K^{+}#pi^{-}) from K* exchanged;m(K^{+}#pi^{-}) [GeV];m(#psi'K^{+}) [GeV]", 110,1.4,2.5, 200,3.6,6.);
  ...
  nB0AC_noMassWin_h = new TH1I("B0_multiplicity_AC_anyMass", "B^{0} multiplicity AC;B^{0} multiplicity;Events", 10, -0.5, 9.5) ;
  nB0AC_h = new TH1I("B0_multiplicity_AC", "B0 multiplicity AC;B^{0} multiplicity;Events", 10, -0.5, 9.5) ;
  nB0AC_signalWin_h = new TH1I("B0_multiplicity_AC_signalWin", "B^{0} multiplicity AC in signal Win;B^{0} multiplicity;Events", 10, -0.5, 9.5) ;
  nB0AC_purityWin_h = new TH1I("B0_multiplicity_AC_purityWin", "B^{0} multiplicity AC in purity Win;B^{0} multiplicity;Events", 10, -0.5, 9.5) ;
  ...
  hPionfromB_p_1B0 = new TH1F("PionfromB_p_1B0","#pi^{-} from 1 B^{0};p [GeV]", 200,0.,10.);
  hKaonfromB_p_1B0 = new TH1F("KaonfromB_p_1B0","K^{+} from 1 B^{0};p [GeV]", 200,0.,10.);
  hPionfromB_pt_1B0 = new TH1F("PionfromB_pT_1B0","#pi^{-} from 1 B^{0};p_{T} [GeV]", 200,0.,10.);
  hKaonfromB_pt_1B0 = new TH1F("KaonfromB_pT_1B0","K^{+} from 1 B^{0};p_{T} [GeV]", 200,0.,10.);
  kaonP_vs_pionP_1B0 = new TH2F("kaonP_vs_pionP_1B0","p(K^{+}) vs p(#pi^{-}) for 1 B^{0};p(#pi^{-}) [GeV];p(K^{+}) [GeV]",100,0.,10.,100,0.,10.) ;
  kaonPt_vs_pionPt_1B0 = new TH2F("kaonPt_vs_pionPt_1B0","p_{T}(K^{+}) vs p_{T}(#pi^{-}) for 1 B^{0};p_{T}(#pi^{-}) [GeV];p_{T}(K^{+}) [GeV]",100,0.,10.,100,0.,10.) ;
  dEdx_vs_p_1B0 = new TH2F("dEdx_vs_p_KAndPiFromB0", "dE/dx vs p for K^{+} and #pi^{-} from 1 B^{0};p(K^{+},#pi^{-}) [GeV];dE/dx [MeV/cm]", 200,0,5, 200, 0, 10) ;
  dEdx_vs_pT_1B0 = new TH2F("dEdx_vs_pT_KAndPiFromB0", "dE/dx vs p_{T} for K^{+} and #pi^{-} from 1 B^{0};p_{T}(K^{+},#pi^{-}) [GeV];dE/dx [MeV/cm]", 200,0,5, 200, 0, 10) ;
  //
...
Bool_t psiPrimePiK_MC::Process(Long64_t entry)
{
  ...
  */
  ...
  //
  // J/psi
  Bool_t HLT_8_Jpsi_v3 = false, HLT_8_Jpsi_v4 = false, HLT_8_Jpsi_v5 = false, HLT_8_Jpsi_v6 = false, HLT_8_Jpsi_v7 = false ;
  Bool_t HLT_8_Jpsi_vAll = false ;
  // psi(2S)
  ...
  for (Int_t i = 0; i != abs(TrigRes->size()); ++i)
	...
	if (!HLT_Displaced) {
	  // J/psi
	  if ( TrigNames->at(i).find("HLT_Dimuon8_Jpsi_v3") != string::npos  &&  TrigRes->at(i) == 1 ) HLT_8_Jpsi_v3 = true;
	  if ( TrigNames->at(i).find("HLT_Dimuon8_Jpsi_v4") != string::npos  &&  TrigRes->at(i) == 1 ) HLT_8_Jpsi_v4 = true;
	  if ( TrigNames->at(i).find("HLT_Dimuon8_Jpsi_v5") != string::npos  &&  TrigRes->at(i) == 1 ) HLT_8_Jpsi_v5 = true;
	  if ( TrigNames->at(i).find("HLT_Dimuon8_Jpsi_v6") != string::npos  &&  TrigRes->at(i) == 1 ) HLT_8_Jpsi_v6 = true;
	  if ( TrigNames->at(i).find("HLT_Dimuon8_Jpsi_v7") != string::npos  &&  TrigRes->at(i) == 1 ) HLT_8_Jpsi_v7 = true;
	  // psi(2S)
	  //--0
  ...
  // J/psi
  if (HLT_8_Jpsi_v3 || HLT_8_Jpsi_v4 || HLT_8_Jpsi_v5 || HLT_8_Jpsi_v6 || HLT_8_Jpsi_v7) HLT_8_Jpsi_vAll = true;
  // psi(2S)
  ...
  for (Int_t myJIdx=0; myJIdx<abs(nMuMu); myJIdx++) {
    ...
    if ( HLT_8_Jpsi_vAll )
      myInclusiveMuMuMass_HLT_8_Jpsi->Fill( (*MuMuMass)[myJIdx] ) ;
  }
  ...
  */
  ...
  for (Int_t myB0Idx = 0; myB0Idx < abs(nB0); myB0Idx++) {
    ...
    Float_t mumu_PDGmass = 99. ;
    if ( (*MuMuType)[myjpsiindex] == 1 )
      mumu_PDGmass = jpsi_mass ;
    else if ( (*MuMuType)[myjpsiindex] == 2 )
      mumu_PDGmass = psi2S_mass ;
    ...
    for (Int_t i = 0; i < abs(trk_pT.size()); ++i) 
      if ( Kp4.Pt() > trk_pT[i] )
	MuMuKMass_trk2Pt[i]->Fill( (Jp4 + Kp4).Mag() - Jp4.M() + mumu_PDGmass ) ;
  ...
  //
  TLorentzVector Protonp4_orig_1B0, Protonp4_orig_ex_1B0, Kp4_orig_1B0, Kp4_orig_ex_1B0 ;
  TLorentzVector Protonp4_1B0, Protonp4_ex_1B0, Kp4_1B0, Kp4_ex_1B0 ;
  Int_t proton_orig_Idx_1B0 = 9999, ka_orig_Idx_1B0 = 9999 ;
  Float_t Proton_dEdx_1B0 = 0, Kaon_dEdx_1B0 = 0 ;
  Float_t Kstar_min = 0.85, Kstar_max = 0.95 +1 ; // + proton_mass
  Float_t Kstar_lowSB = 0.8, Kstar_highSB = 1. +1 ; // + proton_mass
  Float_t myB0MassAlt = 0., myB0MassAlt_ex = 0. ;
  //
  ...
  // twin variables
  Float_t DeltaR_2B0[2][2] = {{99,99},{99,99}}, DeltaPt_2B0[2][2] = {{99,99},{99,99}}, B0VtxCL_2B0[2] = {-1,-1}, B0Mass_2B0[2][2] = { {-1,-1},{-1,-1} }, B0CTau_2B0[2][2] = { {-1,-1},{-1,-1} }, alpha_2B0[2][2] = {{-2,-2},{-2,-2}} ;
  ...
  for (Int_t myB0Idx = 0; myB0Idx < abs(nB0); myB0Idx++) {  
    ...
    //      
    Float_t J_E = 0., mu1_E = 0., mu2_E = 0., K_E = 0., proton_E = 0. ; // BcE = 0.,
    // 
    ...
    */
    ...
    if ( 1
	 ...
	 &&  fabs(Pip4.Eta()) < 1.5
	 &&  fabs(Jp4.Eta()) < 1.5
	 &&  fabs( Jp4.M() - mumu_PDGmass ) < 0.06  // we applied a moving window on the onePsiPrime selection
	 ...
	 &&  mu1.Pt() > 7.0  &&  mu2.Pt() > 7.0
      ...
      myMuMuPiMass_Kai->Fill( Zp4.M() - Jp4.M() + mumu_PDGmass ) ;
      if (HLT_7_vAll  &&  Jp4.Pt() > 7.) myMuMuPiMass_Kai_HLT7->Fill( Zp4.M() - Jp4.M() + mumu_PDGmass ) ;
    }
	...
	if ( 1
	  ...
	  if (!only1psiPrime) {
	    if (fixedMassWind) {
	      //Float_t fixed_sigma = 0.150 ;
	      Float_t fixed_sigma = 0.200 ;
	      if ( fabs(Jp4.M() - mumu_PDGmass) < fixed_sigma ) {
		//myMuMuMass_KaiBF->Fill( Jp4.M() ) ;
		myMuMuKMass_KaiBF->Fill( (Jp4 + Kp4).Mag() - Jp4.M() + mumu_PDGmass ) ;

		if ( ((Jp4 + Kp4).Mag() - Jp4.M() + mumu_PDGmass) > 5.268  &&  ((Jp4 + Kp4).Mag() - Jp4.M() + mumu_PDGmass) < 5.288 )
		  myMuMuMass_KaiBF->Fill( Jp4.M() ) ;
	      }
	    } else if ( fabs( Jp4.M() - mumu_PDGmass ) < 0.12 ) {
	      myMuMuKMass_KaiBF->Fill( (Jp4 + Kp4).Mag() - Jp4.M() + mumu_PDGmass ) ;
	    }
	  } else if (only1psiPrime) {
	    myMuMuKMass_KaiBF->Fill( (Jp4 + Kp4).Mag() - Jp4.M() + mumu_PDGmass ) ;
    ...
    */
    ...
    if ( HLT_5_vAll ) { // trigger
	  ...
	  //MuMuKMass_ZCTauBSOverE[i]->Fill( (Jp4 + Kp4).Mag() - Jp4.M() + mumu_PDGmass ) ;
	  }
	for (Int_t i = 0; i < abs(mu_pT.size()); ++i) {
	  if ( mu1.Pt() > mu_pT[i] )
	    MuMuKMass_mu1Pt[i]->Fill( (Jp4 + Kp4).Mag() - Jp4.M() + mumu_PDGmass ) ;
	  if ( mu2.Pt() > mu_pT[i] )
	    MuMuKMass_mu2Pt[i]->Fill(( Jp4 + Kp4).Mag() - Jp4.M() + mumu_PDGmass ) ;
	}
	for (Int_t i = 0; i < abs(trk_pT.size()); ++i) {
	  if ( Pip4.Pt() > trk_pT[i] )
	    MuMuKMass_trk1Pt[i]->Fill( (Jp4 + Kp4).Mag() - Jp4.M() + mumu_PDGmass ) ;
	...
	//MuMuKMass_ZCL[i]->Fill( (Jp4 + Kp4).Mag() - Jp4.M() + mumu_PDGmass ) ;
    ...
    */
	...
	if ( 1
	     ...
	     && fabs( Jp4.M() - mumu_PDGmass ) < 0.12  // same as && fabs((*MuMuMass)[myPsiP_fromZ_Index]-psi2SPDGmass) < 0.12  unchanged
	  ...
	  if ( (((Jp4 + Kp4).Mag() - Jp4.M() + mumu_PDGmass > 5.15)  &&  ((Jp4 + Kp4).Mag() - Jp4.M() + mumu_PDGmass < 5.2))  || 
	       (((Jp4 + Kp4).Mag() - Jp4.M() + mumu_PDGmass > 5.35)  &&  ((Jp4 + Kp4).Mag() - Jp4.M() + mumu_PDGmass < 5.4) )) {
	    MuMuKMass_sb->Fill( (Jp4 + Kp4).Mag() - Jp4.M() + mumu_PDGmass ) ;
	  ...
	  if ( 1 // B+ cuts
	    ...
	    MuMuKMass_Nairit->Fill( (Jp4 + Kp4).Mag() - Jp4.M() + mumu_PDGmass ) ;
	    dEdx_vs_p_Bplus->Fill(Kp4.P(), ((*tr_dedx)[mypiIdx])) ;

	    if ( ((Jp4 + Kp4).Mag() - Jp4.M() + mumu_PDGmass > 5.25)  &&  ((Jp4 + Kp4).Mag() - Jp4.M() + mumu_PDGmass < 5.31) ) {
    ...
    */
	...
	J_E_gen = sqrt( pow((*MCpsi2SPx)[myMCB0Idx], 2) + pow((*MCpsi2SPy)[myMCB0Idx], 2) + pow((*MCpsi2SPz)[myMCB0Idx], 2) + pow(mumu_PDGmass, 2) ) ; // check the mumuPDG_mass usage
	...
	*/
	...
	// set indices
	Int_t psip_index = (*B0MuMuIdx)[myB0Idx]; // neglect only1PsiPrime
	mumu_PDGmass = 99. ;
	if ( (*MuMuType)[psip_index] == 1 )
	  mumu_PDGmass = jpsi_mass ;
	else if ( (*MuMuType)[psip_index] == 2 )
	  mumu_PDGmass = psi2S_mass ;
	...
	//
	TLorentzVector protonp4, protonp4_exchanged;
	proton_E = sqrt( pow((*PionPx_MuMuPiK)[myB0Idx],2) + pow((*PionPy_MuMuPiK)[myB0Idx],2) + pow((*PionPz_MuMuPiK)[myB0Idx],2) + pow(proton_mass,2) ) ;
	protonp4.SetPxPyPzE( (*PionPx_MuMuPiK)[myB0Idx], (*PionPy_MuMuPiK)[myB0Idx], (*PionPz_MuMuPiK)[myB0Idx], proton_E) ;
	      
	TLorentzVector kp4, kp4_exchanged;
	K_E = sqrt( pow((*KaonPx_MuMuPiK)[myB0Idx],2) + pow((*KaonPy_MuMuPiK)[myB0Idx],2) + pow((*KaonPz_MuMuPiK)[myB0Idx],2) + pow(proton_mass,2) ) ; 
	kp4.SetPxPyPzE( (*KaonPx_MuMuPiK)[myB0Idx], (*KaonPy_MuMuPiK)[myB0Idx], (*KaonPz_MuMuPiK)[myB0Idx], K_E) ;

	TLorentzVector Protonp4_orig, Protonp4_orig_ex, Kp4_orig, Kp4_orig_ex;
	proton_E = sqrt( pow((*trackPx)[pi_orig_Index],2) + pow((*trackPy)[pi_orig_Index],2) + pow((*trackPz)[pi_orig_Index],2) + pow(proton_mass,2) ) ;
	Protonp4_orig.SetPxPyPzE( (*trackPx)[pi_orig_Index], (*trackPy)[pi_orig_Index], (*trackPz)[pi_orig_Index], proton_E) ; // original
	Protonp4_orig_ex.SetVectM(Protonp4_orig.Vect(), kaonCh_mass) ;
	Int_t Proton_orig_ch = (*trackCharge)[pi_orig_Index] ;
	Int_t K_orig_ch = (*trackCharge)[ka_orig_Index] ;

	//K_E = sqrt( pow((*trackPx)[ka_orig_Index],2) + pow((*trackPy)[ka_orig_Index],2) + pow((*trackPz)[ka_orig_Index],2) + pow(kaonCh_mass,2) ) ; 
	K_E = sqrt( pow((*trackPx)[ka_orig_Index],2) + pow((*trackPy)[ka_orig_Index],2) + pow((*trackPz)[ka_orig_Index],2) + pow(proton_mass,2) ) ; 
	Kp4_orig.SetPxPyPzE( (*trackPx)[ka_orig_Index], (*trackPy)[ka_orig_Index], (*trackPz)[ka_orig_Index], K_E) ; 
	//Kp4_orig.SetPxPyPzE( (*trackPx)[ka_orig_Index], (*trackPy)[ka_orig_Index], (*trackPz)[ka_orig_Index], (*trackEnergy)[ka_orig_Index]) ; // original but trackEnergy is filled with the mass assumpion of ? Answer: pion!

	Kp4_orig_ex.SetVectM(Kp4_orig.Vect(), proton_mass) ;
	      
	TLorentzVector Kstarp4, Kstarp4_orig, Kstarp4_orig_ex, myB0p4, myB0p4_orig, myB0p4_KPiExchanged;
	Kstarp4 = protonp4 + kp4 ;
	Kstarp4_orig = Protonp4_orig + Kp4_orig ;
	Kstarp4_orig_ex = Protonp4_orig_ex + Kp4_orig_ex ;
	myB0p4 = PsiPp4 + protonp4 + kp4;
	myB0p4_orig = PsiPp4 + Protonp4_orig + Kp4_orig;
	// alternatively:
	myB0MassAlt = (PsiPp4 + Protonp4_orig + Kp4_orig).Mag() - PsiPp4.M() + mumu_PDGmass;
	myB0MassAlt_ex = (PsiPp4 + Protonp4_orig_ex + Kp4_orig_ex).Mag() - PsiPp4.M() + mumu_PDGmass;
	//
	protonp4_exchanged.SetVectM(protonp4.Vect(), kaonCh_mass) ;
	kp4_exchanged.SetVectM(kp4.Vect(), proton_mass) ;
	myB0p4_KPiExchanged = PsiPp4 + protonp4_exchanged + kp4_exchanged;
	//
	// Armenteros plot
	// original tracks
	Float_t pi_KstarPl_orig = ( (Protonp4_orig.Vect()).Dot(Kstarp4_orig.Vect()) ) / Kstarp4_orig.Rho()  ; 
	...
	Float_t pi_KstarPt_orig = sqrt( pow(Protonp4_orig.Rho(),2) - pow(pi_KstarPl_orig,2) ) ;
	Float_t K_KstarPt_orig = sqrt( pow(Kp4_orig.Rho(),2) - pow(K_KstarPl_orig,2) ) ;
	// refitted tracks
	Float_t pi_KstarPl = ( (protonp4.Vect()).Dot(Kstarp4.Vect()) ) / Kstarp4.Rho()  ; 
	Float_t K_KstarPl = ( (kp4.Vect()).Dot(Kstarp4.Vect()) ) / Kstarp4.Rho() ;  
	Float_t alpha = (pi_KstarPl - K_KstarPl)/(pi_KstarPl + K_KstarPl) ; 
	Float_t pi_KstarPt = sqrt( pow(protonp4.Rho(),2) - pow(pi_KstarPl,2) ) ;
	//Float_t K_KstarPt = sqrt( pow(kp4.Rho(),2) - pow(K_KstarPl,2) ) ;
	// for exchanged particles
	Float_t pi_ex_KstarPl = ( (Protonp4_orig_ex.Vect()).Dot(Kstarp4_orig_ex.Vect()) ) / Kstarp4_orig_ex.Rho()  ; 
	...
	Float_t pi_ex_KstarPt = sqrt( pow(Protonp4_orig_ex.Rho(),2) - pow(pi_ex_KstarPl,2) ) ;
	Float_t K_ex_KstarPt = sqrt( pow(Kp4_orig_ex.Rho(),2) - pow(K_ex_KstarPl,2) ) ;
	//
	exclusiveMuMuKPiMass->Fill( (*B0Mass)[myB0Idx] ) ; // B0mass before any selection
	...
	hPionfromB_pt->Fill( pion_fromB0_Pt );
	hKaonfromB_pt->Fill( kaon_fromB0_Pt );
	//
	////////////////////////////////
	...
	//cout <<"\nafter SoftMuon ID" <<endl ;
	////////////////////////////////
	Bool_t Mu1_PtSel = false;
	Bool_t Mu2_PtSel = false;
	if ( ( ( (fabs(mu1_p4.Eta()) < 1.2 ) && (mu1_p4.Pt() > 4.)) ) || ( (fabs(mu1_p4.Eta()) >= 1.2) && (mu1_p4.Pt() > 3.3) ) ) Mu1_PtSel = true;
	if ( ( ( (fabs(mu2_p4.Eta()) < 1.2 ) && (mu2_p4.Pt() > 4.)) ) || ( (fabs(mu2_p4.Eta()) >= 1.2) && (mu2_p4.Pt() > 3.3) ) ) Mu2_PtSel = true;
	////////////////////////////////
	//
	//cout <<"\nbefore PV_matching_cuts" <<endl ;
	if ( 1
	...
	//
	//cout <<"\nbefore B0_selectionCuts" <<endl ;
	if ( 1 
	     && ( (*B0Vtx_CL)[myB0Idx] > 0.05 )
	     //&& ( (*B0CosAlphaPV)[myB0Idx] > 0.9 ) // 0.99
	     && ( (*B0CosAlphaPV)[myB0Idx] > 0.99 ) && ( !B0CosAlpha3DPV || (B0CosAlpha3DPV && ((*B0CosAlpha3DPV)[myB0Idx] > 0.99)) )
	     && ( (*B0CTauPV)[myB0Idx]/(*B0CTauPVE)[myB0Idx] > 3.5 ) // 7
	     )
	  BO_selectionCuts = kTRUE ;
	//
	//cout <<"\nafter B0_selectionCuts" <<endl ;
	if ( 1 && newsoftID 
	     && ( fabs( (*MuMuMass)[psip_index] - mumu_PDGmass ) < 0.12 )
	  ...
	  {
	    if ( BO_selectionCuts ) {
	      exclMuMuKPiMassSel->Fill( (*B0Mass)[myB0Idx] ) ;
	      ...
	      psi2SPiSqMass_vs_KPiSqMass_ABaseC->Fill( (kp4 + protonp4).M2(), (PsiPp4 + protonp4).M2() );
	...
	if ( 1 
	     && B0_Pt > 8.
	     //&& pion_fromB0_Pt > 0.7
	     && PsiPp4.DeltaR( protonp4 ) < 1.0 //0.5
	  ...
	  {
	    // PV matching
	    //cout <<"\nbefore PV matching" <<endl ;
	    if ( baselinePVMatching
		 && Protonp4_orig.Pt() > 2. && Kp4_orig.Pt() > 2.
	    ...
	    //cout <<"\nafter PV matching" <<endl ;
	    //
	    if ( baselineB0Sel ) {
	      nB0AC_noMassWin++ ;

	      if (PsiPp4.DeltaR(protonp4) < 0.4  &&  PsiPp4.DeltaR(kp4) < 0.4)
		hmyPsiPKPiMass_deltaRtest->Fill( myB0MassAlt );
	      //cout <<"\nbefore B0CTauPV" <<endl ;
		...
		//if ( (Protonp4_orig + Kp4_orig).M() > Kstar_min  &&  (Protonp4_orig + Kp4_orig).M() < Kstar_max )
		//  if ( fabs(myB0MassAlt - 5.280808) < 2*0.00816 ) {
		//    hPionFromKstar_p->Fill( Protonp4_orig.P() );
		//    hKaonFromKstar_p->Fill( Kp4_orig.P() );
		//  } // moved below
	      }
	      //cout << "\nafter nB0AC_noMassWin" <<endl ;
	      
	      kaonP_vs_pionP->Fill( Protonp4_orig.P(),Kp4_orig.P() ) ;
	      kaonPt_vs_pionPt->Fill( Protonp4_orig.Pt(),Kp4_orig.Pt() ) ;
	      ...
	      // tight cuts
	      //cout << "\nbefore tight cuts" <<endl ;
	      for (Int_t i = 0; i < abs(piPt_B0.size()); ++i)
		if (Protonp4_orig.Pt() > piPt_B0[i]) 
		...
		if ((*B0CTauPV)[myB0Idx]/(*B0CTauPVE)[myB0Idx] > cTau_B0[i]) 
	      ...
	      // combined
	      for (Int_t i = 0; i < abs(trksPt_B0VtxCL_B0CTau.size()); ++i)
		if ( (Protonp4_orig.Pt() > trksPt_B0VtxCL_B0CTau[i].trksPt) && (Kp4_orig.Pt() > trksPt_B0VtxCL_B0CTau[i].trksPt) &&
	      ...
	      //cout <<"\nbefore B0 mass window" <<endl ;
	      if ( myB0MassAlt > 5.15  &&  myB0MassAlt < 5.45 ) {
		nB0AC++ ;

		psi2SPiSqMass_vs_KPiSqMass_AC->Fill( (kp4 + protonp4).M2(), (PsiPp4 + protonp4).M2() );
		...
		if ( MC ) {
		  ...
		  for (Int_t myMCB0Idx = 0; myMCB0Idx < abs(nMCB0); myMCB0Idx++) { // only 0 and 1 candidate
		    ...
		    //      
		    Float_t J_E_gen = 0, K_E_gen = 0, Pi_E_gen = 0 ;
		    J_E_gen = sqrt( pow((*MCpsi2SPx)[myMCB0Idx], 2) + pow((*MCpsi2SPy)[myMCB0Idx], 2) + pow((*MCpsi2SPz)[myMCB0Idx], 2) + pow(mumu_PDGmass, 2) ) ;
		    K_E_gen = sqrt( pow((*MCkaonPx)[myMCB0Idx], 2) + pow((*MCkaonPy)[myMCB0Idx], 2) + pow((*MCkaonPz)[myMCB0Idx], 2) + pow(kaonCh_mass, 2) ) ;
		    Pi_E_gen = sqrt( pow((*MCpionPx)[myMCB0Idx], 2) + pow((*MCpionPy)[myMCB0Idx], 2) + pow((*MCpionPz)[myMCB0Idx], 2) + pow(pionCh_mass, 2) ) ;
		    //
		    Jp4_gen.SetPxPyPzE( (*MCpsi2SPx)[myMCB0Idx], (*MCpsi2SPy)[myMCB0Idx], (*MCpsi2SPz)[myMCB0Idx], J_E_gen ) ;
		...
		if ( !MC || (MC && nMCB0>0) ) {
		  ...
		  if ( (nB0AC == 1 ) ) {
		    ...
		    Protonp4_orig_1B0 = Protonp4_orig; Protonp4_orig_ex_1B0 = Protonp4_orig_ex;
		    Protonp4_1B0 = protonp4; Protonp4_ex_1B0 = protonp4_exchanged;
		    proton_orig_Idx_1B0 = pi_orig_Index ;
		    Proton_dEdx_1B0 = (*tr_dedx)[proton_orig_Idx_1B0] ;
		    //
		    Kp4_orig_1B0 = Kp4_orig; Kp4_orig_ex_1B0 = Kp4_orig_ex;
		    Kp4_1B0 = kp4; Kp4_ex_1B0 = kp4_exchanged;
		    ka_orig_Idx_1B0 = ka_orig_Index ;
		    Kaon_dEdx_1B0 = (*tr_dedx)[ka_orig_Idx_1B0] ;
		    //
		    pB0_XYZ[0] = (*B0Px)[myB0Idx] ; pB0_XYZ[1] = (*B0Py)[myB0Idx] ; pB0_XYZ[2] = (*B0Pz)[myB0Idx] ;
		    B0CTau_2B0[0][0] = (*B0CTauPV)[myB0Idx]/(*B0CTauPVE)[myB0Idx] ;
		    alpha_2B0[0][0] = alpha_orig;
		    ...
		    if ( B0CosAlphaPV )
		      priVtx_XYZ[3] = (*B0CosAlphaPV)[myB0Idx] ;
		    if ( B0CosAlpha3DPV )
		      priVtx_XYZ[4] = (*B0CosAlpha3DPV)[myB0Idx] ;
		    ...
		    //cout <<"\nafter priVtx variables setting" <<endl ;
			      
 
		    B0Mass_2B0[0][nB0AC-1] = myB0MassAlt ;
		    PsiPp4_2B0[0][nB0AC-1] = PsiPp4; Pip4_2B0[0][nB0AC-1] = Protonp4_orig; Kp4_2B0[0][nB0AC-1] = Kp4_orig ;
		    PiCharge_2B0[0][nB0AC-1] = (*trackCharge)[pi_orig_Index] ; KCharge_2B0[0][nB0AC-1] = (*trackCharge)[ka_orig_Index] ;
		    //
		    twins_var[0][0] = PsiPp4.M(); twins_var[0][1] = PsiPp4.Pt(); twins_var[0][2] = Kp4_orig.Pt(); twins_var[0][3] = Protonp4_orig.Pt();
		    ...
		    if ( MC ) {
		      ...
		      Double_t DrPi = truePi4Vec[0].DeltaR(Protonp4_orig) ; // DeltaR between true pi and reco pi
		      Double_t piPtDiff = fabs(truePi4Vec[0].Pt() - Protonp4_orig.Pt())/truePi4Vec[0].Pt() ;
		    ...
		    PsiPp4_2B0[0][nB0AC-1] = PsiPp4; Pip4_2B0[0][nB0AC-1] = Protonp4_orig; Kp4_2B0[0][nB0AC-1] = Kp4_orig ;
		    PiCharge_2B0[0][nB0AC-1] = (*trackCharge)[pi_orig_Index] ; KCharge_2B0[0][nB0AC-1] = (*trackCharge)[ka_orig_Index] ;
		    alpha_2B0[0][1] = alpha_orig;
		    //
		    twins_var[1][0] = PsiPp4.M(); twins_var[1][1] = PsiPp4.Pt(); twins_var[1][2] = Kp4_orig.Pt(); twins_var[1][3] = Protonp4_orig.Pt();
		...
		if ( fabs(myB0MassAlt - B0_massFit) < 3*B0_sigmaFit ) {
		  ...
		  if ( (!MC && (nB0AC_signalWin == 1)) || nB0ACInMC == 1 ) {
			...
			Double_t DrMuMu = trueMuMu4Vec[0].DeltaR(PsiPp4) ; // DeltaR between true psi' and reco psi'
			Double_t MuMuPtDiff = fabs(trueMuMu4Vec[0].Pt() - PsiPp4.Pt())/trueMuMu4Vec[0].Pt() ;
			Double_t DrPi = truePi4Vec[0].DeltaR(Protonp4_orig) ; // DeltaR between true psi' and reco psi'
			Double_t piPtDiff = fabs(truePi4Vec[0].Pt() - Protonp4_orig.Pt())/truePi4Vec[0].Pt() ;
		    ...
		    alpha_2B0[1][1] = alpha_orig;
		    PsiPp4_2B0[1][1] = PsiPp4; Pip4_2B0[1][1] = Protonp4_orig; Kp4_2B0[1][1] = Kp4_orig ;
		  ...
		  //float partMass = (partNum == psi2S_PDGId) ? mumu_PDGmass : X3872PDG;
		  ...
		  psi2SGen4Mom.SetXYZM((*MCPx)[it],(*MCPy)[it],(*MCPz)[it], mumu_PDGmass);
    ...
    if ( 
      ...
      //
      // && fabs(Jp4.Eta())<1.5 && fabs(Protonp4.Eta())<1.5
      //         && Jp4.DeltaR(Protonp4)<0.7
      //         && Z_Pt > 10.0
      ...
      && fabs(Protonp4.Rapidity()) < 2.4
      && Protonp4.Pt() > 0.7 //1
      && Jp4.DeltaR(Protonp4) < 1.0
      ...
      pi_pT_test_h->Fill( Protonp4.Pt() ) ;
      pi_y_test_h->Fill( Protonp4.Rapidity() ) ;
      pT_vs_pixelHits_pi_h->Fill( (Float_t)((*trackPhits)[mypiIdx]), Protonp4.Pt() ) ;
      pT_vs_stripHits_pi_h->Fill( (Float_t)((*trackShits)[mypiIdx]), Protonp4.Pt() ) ;
      pT_vs_y_pi_h->Fill( Protonp4.Rapidity(), Protonp4.Pt() ) ;
      ...
      psi2S_DeltaR_pi_h[0]->Fill( Jp4.DeltaR(Protonp4) ) ; 
      if ((*ZCTauBS)[myB0Idx] / (*ZCTauBSE)[myB0Idx] > 3.0)
      psi2S_DeltaR_pi_vs_mumupiMass_nonpr->Fill( (*MuMuPiMass)[myB0Idx] - Jp4.M() + mumu_PDGmass, Jp4.DeltaR(Protonp4) ) ;
      ...
      Z_DeltaR_vs_cosPA[0]->Fill( fabs((*ZCosAlphaPV)[myB0Idx]), Jp4.DeltaR(Protonp4) ) ;
      if ( fabs((*ZCosAlphaPV)[myB0Idx]) > cosAlpha_cut2 ) {
      Z_vs_pi_pT_h->Fill( Protonp4.Pt(), Z_Pt) ;
      Z_CTauBS_over_Z_CTauBSE_h->Fill( (*ZCTauBS)[myB0Idx] / (*ZCTauBSE)[myB0Idx] ) ;
      }
      myMuMuPiMass->Fill( (*MuMuPiMass)[myB0Idx] - Jp4.M() + mumu_PDGmass ) ;
      
      
      ///////////////////////// START SCANNING /////////////////////////
      
      for (Int_t k = 0; k < abs(deltaR_piPsi2S.size()); ++k)
        if (Jp4.DeltaR(Protonp4) < deltaR_piPsi2S[k]) {
	  for (Int_t j = 0; j < abs(pi_pT.size()); ++j)
	    if (Protonp4.Pt() > pi_pT[j]) 
	      myMuMuPiMass_piPt[0][j][k]->Fill( (*MuMuPiMass)[myB0Idx] - Jp4.M() + mumu_PDGmass ) ; // i=0 -> all
	    for (Int_t j = 0; j < abs(Z_pT.size()); ++j) 
	      if (Z_Pt > Z_pT[j]) 
	        myMuMuPiMass_ZPt[0][j][k]->Fill( (*MuMuPiMass)[myB0Idx] - Jp4.M() + mumu_PDGmass ) ; // i=0 -> all
		  for (Int_t j = 0; j < abs(piAndZ_pT.size()); ++j)
		    if (Protonp4.Pt() > piAndZ_pT[j].first  &&  Z_Pt > piAndZ_pT[j].second) 
		      myMuMuPiMass_piAndZPt[0][j][k]->Fill( (*MuMuPiMass)[myB0Idx] - Jp4.M() + mumu_PDGmass ) ; // i=0 -> all ;
	}
    ...
    psi2S_DeltaR_pi_h[1]->Fill( Jp4.DeltaR(Protonp4) ) ; psi2S_DeltaR_pi_h[1]->SetLineColor( kBlack ) ;
    ...
    Z_DeltaR_vs_cosPA[1]->Fill( fabs((*ZCosAlphaPV)[myB0Idx]), Jp4.DeltaR(Protonp4) ) ;
    if ( fabs((*ZCosAlphaPV)[myB0Idx]) > cosAlpha_cut2 ) { 
    myMuMuPiMass_pr->Fill( (*MuMuPiMass)[myB0Idx] - Jp4.M() + mumu_PDGmass ) ; myMuMuPiMass_pr->SetLineColor( kBlack ) ;
    for (Int_t k = 0; k < abs(deltaR_piPsi2S.size()); ++k)
    if (Jp4.DeltaR(Protonp4) < deltaR_piPsi2S[k]) {
    for (Int_t j = 0; j < abs(pi_pT.size()); ++j) 
    if (Protonp4.Pt() > pi_pT[j]) {
    myMuMuPiMass_piPt[1][j][k]->Fill( (*MuMuPiMass)[myB0Idx] - Jp4.M() + mumu_PDGmass ) ; // i=1 -> prompt
    myMuMuPiMass_piPt[1][j][k]->SetLineColor( kBlack ) ; } // i=1 -> prompt
    for (Int_t j = 0; j < abs(Z_pT.size()); ++j) 
    if (Z_Pt > Z_pT[j]) {
    myMuMuPiMass_ZPt[1][j][k]->Fill( (*MuMuPiMass)[myB0Idx] - Jp4.M() + mumu_PDGmass ) ; // i=1 -> prompt
    myMuMuPiMass_ZPt[1][j][k]->SetLineColor( kBlack ) ; } // i=1 -> prompt
    for (Int_t j = 0; j < abs(piAndZ_pT.size()); ++j)
    if (Protonp4.Pt() > piAndZ_pT[j].first  &&  Z_Pt > piAndZ_pT[j].second) {
    myMuMuPiMass_piAndZPt[1][j][k]->Fill( (*MuMuPiMass)[myB0Idx] - Jp4.M() + mumu_PDGmass ) ; // i=1 -> prompt ;
    myMuMuPiMass_piAndZPt[1][j][k]->SetLineColor( kBlack ) ; } // i=1 -> prompt
    }
		      
    if ( fabs((*trackDzVtx)[mypiIdx]) < 1) { // pi Dz < 1
    myMuMuPiMass_pr_Dz01->Fill( (*MuMuPiMass)[myB0Idx] - Jp4.M() + mumu_PDGmass ) ; 
    if ( fabs((*trackDzVtx)[mypiIdx]) < 0.4) // pi Dz < 0.4
    myMuMuPiMass_pr_DzCut->Fill( (*MuMuPiMass)[myB0Idx] - Jp4.M() + mumu_PDGmass ) ; }
    }

    if ( fabs(Jp4.Rapidity()) < 1 ) { // prompt barrel i=2
    psi2S_DeltaR_pi_h[2]->Fill( Jp4.DeltaR(Protonp4) ) ; psi2S_DeltaR_pi_h[2]->SetLineColor( kBlack ) ;
    ...
    Z_DeltaR_vs_cosPA[2]->Fill( fabs((*ZCosAlphaPV)[myB0Idx]), Jp4.DeltaR(Protonp4) ) ;
    if ( fabs((*ZCosAlphaPV)[myB0Idx]) > cosAlpha_cut2 ) {
    myMuMuPiMass_barrel_pr->Fill( (*MuMuPiMass)[myB0Idx] - Jp4.M() + mumu_PDGmass ) ; myMuMuPiMass_barrel_pr->SetLineColor( kBlack ) ;
    for (Int_t k = 0; k < abs(deltaR_piPsi2S.size()); ++k) 
    if (Jp4.DeltaR(Protonp4) < deltaR_piPsi2S[k]) {
    for (Int_t j = 0; j < abs(pi_pT.size()); ++j) 
    if (Protonp4.Pt() > pi_pT[j]) {
    myMuMuPiMass_piPt[2][j][k]->Fill( (*MuMuPiMass)[myB0Idx] - Jp4.M() + mumu_PDGmass ) ; // i=2 -> prompt barrel
    myMuMuPiMass_piPt[2][j][k]->SetLineColor( kBlack ) ; } // i=1 -> prompt barrel
    for (Int_t j = 0; j < abs(Z_pT.size()); ++j) 
    if (Z_Pt > Z_pT[j]) {
    myMuMuPiMass_ZPt[2][j][k]->Fill( (*MuMuPiMass)[myB0Idx] - Jp4.M() + mumu_PDGmass ) ; // i=2 -> prompt barrel
    myMuMuPiMass_ZPt[2][j][k]->SetLineColor( kBlack ) ; } // i=2 -> prompt barrel
    for (Int_t j = 0; j < abs(piAndZ_pT.size()); ++j)
    if (Protonp4.Pt() > piAndZ_pT[j].first  &&  Z_Pt > piAndZ_pT[j].second) {
    myMuMuPiMass_piAndZPt[2][j][k]->Fill( (*MuMuPiMass)[myB0Idx] - Jp4.M() + mumu_PDGmass ) ; // i=2 -> prompt barrel;
    myMuMuPiMass_piAndZPt[2][j][k]->SetLineColor( kBlack ) ; } // i=2 -> prompt barrel
    }
    } 
    } else // non barrel
    if ( fabs((*ZCosAlphaPV)[myB0Idx]) > cosAlpha_cut2 ) {
    myMuMuPiMass_nonBarrel_pr->Fill( (*MuMuPiMass)[myB0Idx] - Jp4.M() + mumu_PDGmass ) ;
    myMuMuPiMass_nonBarrel_pr->SetLineColor( kBlack ) ; }
		      
    } else if ( (*ZCTauBS)[myB0Idx] / (*ZCTauBSE)[myB0Idx] < 3.0) { // quasi prompt i=3
    psi2S_DeltaR_pi_h[3]->Fill( Jp4.DeltaR(Protonp4) ) ;
    Z_cosPA[3]->Fill( coeff ) ; 
    Z_cosPA[3].first->Fill( (*ZCosAlphaPV)[myB0Idx] ) ;  Z_cosPA[3].second->Fill( (*ZCosAlphaPV)[myB0Idx] ) ; 
    Z_DeltaR_vs_cosPA[3]->Fill( fabs((*ZCosAlphaPV)[myB0Idx]), Jp4.DeltaR(Protonp4) ) ;
    if ( (*ZCosAlphaPV)[myB0Idx] > cosAlpha_cut2 ) {
    myMuMuPiMass_quasipr->Fill( (*MuMuPiMass)[myB0Idx] - Jp4.M() + mumu_PDGmass ) ;
    for (Int_t k = 0; k < abs(deltaR_piPsi2S.size()); ++k) 
    if (Jp4.DeltaR(Protonp4) < deltaR_piPsi2S[k]) {
    for (Int_t j = 0; j < abs(pi_pT.size()); ++j) 
    if (Protonp4.Pt() > pi_pT[j]) 
    myMuMuPiMass_piPt[3][j][k]->Fill( (*MuMuPiMass)[myB0Idx] - Jp4.M() + mumu_PDGmass ) ; // i=3 -> quasi prompt
    for (Int_t j = 0; j<abs(Z_pT.size()); ++j) 
    if (Z_Pt > Z_pT[j]) 
    myMuMuPiMass_ZPt[3][j][k]->Fill( (*MuMuPiMass)[myB0Idx] - Jp4.M() + mumu_PDGmass ) ; // i=3 -> quasi prompt
    for (Int_t j = 0; j < abs(piAndZ_pT.size()); ++j)
    if (Protonp4.Pt() > piAndZ_pT[j].first  &&  Z_Pt > piAndZ_pT[j].second) 
    myMuMuPiMass_piAndZPt[3][j][k]->Fill( (*MuMuPiMass)[myB0Idx] - Jp4.M() + mumu_PDGmass ) ; // i=3 -> quasi prompt ;
    }
    }

    } else { // non prompt i=4
    pi_Dz_nonpr_h->Fill((*trackDzVtx)[mypiIdx]) ; pi_Dxy_nonpr_h->Fill((*trackDxyVtx)[mypiIdx]) ;
    psi2S_DeltaR_pi_h[4]->Fill( Jp4.DeltaR(Protonp4) ) ; psi2S_DeltaR_pi_h[4]->SetLineColor( kRed ) ;
    ...
    Z_DeltaR_vs_cosPA[4]->Fill( fabs((*ZCosAlphaPV)[myB0Idx]), Jp4.DeltaR(Protonp4) ) ;
    ...
    if (HLT_5_vAll) {
    myMuMuKMass_Kai->Fill( (Jp4 + Kp4).Mag() - Jp4.M() + mumu_PDGmass) ;
    if (mu1.Pt() > mu_pT_cut  &&  mu2.Pt() > mu_pT_cut) {
    myMuMuPiMass_HLT5to3p5->Fill( (*MuMuPiMass)[myB0Idx] - Jp4.M() + mumu_PDGmass ) ;
    myMuMuKMass_HLT5to3p5->Fill( (Jp4 + Kp4).Mag() - Jp4.M() + mumu_PDGmass ) ; 
    if ( (Jp4 + Kp4).Mag() - Jp4.M() + mumu_PDGmass  >  5.24  &&
    (Jp4 + Kp4).Mag() - Jp4.M() + mumu_PDGmass  <  5.32 ) {
    ...
    if (mu1.Pt() > mu_pT_cut  &&  mu2.Pt() > mu_pT_cut) {
    myMuMuPiMass_HLT3p5_allCuts->Fill( (*MuMuPiMass)[myB0Idx] - Jp4.M() + mumu_PDGmass ) ;
    myMuMuKMass_HLT3p5_allCuts->Fill( (Jp4 + Kp4).Mag() - Jp4.M() + mumu_PDGmass ) ;
    if ((Jp4 + Kp4).Mag() - Jp4.M() + mumu_PDGmass  >  5.24  &&
    (Jp4 + Kp4).Mag() - Jp4.M() + mumu_PDGmass  <  5.32 ) {
    mu1_pT_test_h->Fill( mu1.Pt() ) ;  mu2_pT_test_h->Fill( mu2.Pt() ) ;
    mu1_eta_test_h->Fill( mu1.Eta() ) ;  mu2_eta_test_h->Fill( mu2.Eta() ) ; }
    ...
    if ( (*ZCosAlphaPV)[myB0Idx] > cosAlpha_cut2 ) {
    myMuMuPiMass_nonpr->Fill( (*MuMuPiMass)[myB0Idx] - Jp4.M() + mumu_PDGmass ) ; myMuMuPiMass_nonpr->SetLineColor( kRed ) ;
    if ( (*ZCTauBS)[myB0Idx] / (*ZCTauBSE)[myB0Idx] > 5.0  &&  Jp4.DeltaR(Protonp4) < 0.2
    &&  Protonp4.Pt() > 12  &&  Z_Pt > 40 ) {
    myMuMuPiMass_DeltaR0p2_nonpr5->Fill( (*MuMuPiMass)[myB0Idx] - Jp4.M() + mumu_PDGmass ) ; myMuMuPiMass_DeltaR0p2_nonpr5->SetLineColor( kRed ) ; 
    if (Jp4.DeltaR(Protonp4) < 0.1) {
    myMuMuPiMass_DeltaR0p1_nonpr5->Fill( (*MuMuPiMass)[myB0Idx] - Jp4.M() + mumu_PDGmass ) ; myMuMuPiMass_DeltaR0p1_nonpr5->SetLineColor( kRed ) ; }
    if ((*ZCTauBS)[myB0Idx] / (*ZCTauBSE)[myB0Idx] > 8.0) {
    myMuMuPiMass_DeltaR0p2_nonpr8->Fill( (*MuMuPiMass)[myB0Idx] - Jp4.M() + mumu_PDGmass ) ; myMuMuPiMass_DeltaR0p2_nonpr8->SetLineColor( kRed ) ; 
    if (Jp4.DeltaR(Protonp4) < 0.1) {
    myMuMuPiMass_DeltaR0p1_nonpr8->Fill( (*MuMuPiMass)[myB0Idx] - Jp4.M() + mumu_PDGmass ) ; myMuMuPiMass_DeltaR0p1_nonpr8->SetLineColor( kRed ) ; }
    }
    }
    for (Int_t k = 0; k < abs(deltaR_piPsi2S.size()); ++k)
    if (Jp4.DeltaR(Protonp4) < deltaR_piPsi2S[k]) {
    for (Int_t j = 0; j < abs(pi_pT.size()); ++j) 
    if (Protonp4.Pt() > pi_pT[j]) {
    myMuMuPiMass_piPt[4][j][k]->Fill( (*MuMuPiMass)[myB0Idx] - Jp4.M() + mumu_PDGmass ) ; // i=4 -> non prompt
    myMuMuPiMass_piPt[4][j][k]->SetLineColor( kRed ) ; } // i=4 -> non prompt
    for (Int_t j = 0; j<abs(Z_pT.size()); ++j) 
    if (Z_Pt > Z_pT[j]) {
    myMuMuPiMass_ZPt[4][j][k]->Fill( (*MuMuPiMass)[myB0Idx] - Jp4.M() + mumu_PDGmass ) ; // i=4 -> non prompt
    myMuMuPiMass_ZPt[4][j][k]->SetLineColor( kRed ) ; } // i=4 -> non prompt
    for (Int_t j = 0; j < abs(piAndZ_pT.size()); ++j)
    if (Protonp4.Pt() > piAndZ_pT[j].first  &&  Z_Pt > piAndZ_pT[j].second) {
    myMuMuPiMass_piAndZPt[4][j][k]->Fill( (*MuMuPiMass)[myB0Idx] - Jp4.M() + mumu_PDGmass ) ; // 4=1 -> non prompt ;
    myMuMuPiMass_piAndZPt[4][j][k]->SetLineColor( kRed ) ; } // i=4 -> non prompt
    }
    }
		      
    if ( fabs(Jp4.Rapidity()) < 1 ) { // non prompt barrel i=5
    psi2S_DeltaR_pi_h[5]->Fill( Jp4.DeltaR(Protonp4) ) ; psi2S_DeltaR_pi_h[5]->SetLineColor( kRed ) ;
    ...
    Z_DeltaR_vs_cosPA[5]->Fill( fabs((*ZCosAlphaPV)[myB0Idx]), Jp4.DeltaR(Protonp4) ) ;
    if ( (*ZCosAlphaPV)[myB0Idx] > cosAlpha_cut2 ) {
    myMuMuPiMass_barrel_nonpr->Fill( (*MuMuPiMass)[myB0Idx] - Jp4.M() + mumu_PDGmass ) ;
    for (Int_t k = 0; k < abs(deltaR_piPsi2S.size()); ++k) 
    if (Jp4.DeltaR(Protonp4) < deltaR_piPsi2S[k]) {
    for (Int_t j = 0; j < abs(pi_pT.size()); ++j) 
    if (Protonp4.Pt() > pi_pT[j]) {
    myMuMuPiMass_piPt[5][j][k]->Fill( (*MuMuPiMass)[myB0Idx] - Jp4.M() + mumu_PDGmass ) ; // i=5 -> non prompt barrel
    myMuMuPiMass_piPt[5][j][k]->SetLineColor( kRed ) ; } // i=5 -> non prompt barrel
    for (Int_t j = 0; j < abs(Z_pT.size()); ++j) 
    if (Z_Pt > Z_pT[j]) {
    myMuMuPiMass_ZPt[5][j][k]->Fill( (*MuMuPiMass)[myB0Idx] - Jp4.M() + mumu_PDGmass ) ; // i=5 -> non prompt barrel
    myMuMuPiMass_ZPt[5][j][k]->SetLineColor( kRed ) ; } // i=5 -> non prompt barrel
    for (Int_t j = 0; j < abs(piAndZ_pT.size()); ++j)
    if (Protonp4.Pt() > piAndZ_pT[j].first  &&  Z_Pt > piAndZ_pT[j].second) { 
    myMuMuPiMass_piAndZPt[5][j][k]->Fill( (*MuMuPiMass)[myB0Idx] - Jp4.M() + mumu_PDGmass ) ; // i=5 -> non prompt barrel
    myMuMuPiMass_piAndZPt[5][j][k]->SetLineColor( kRed ) ; } // i=5 -> non prompt barrel
    }
						
    if ( fabs((*trackDzVtx)[mypiIdx]) > 1) // pi Dz > 1
    myMuMuPiMass_nonpr_Dz1inf->Fill( (*MuMuPiMass)[myB0Idx] - Jp4.M() + mumu_PDGmass ) ; 
    }
    }
    }
    if ( fabs(Jp4.Rapidity()) < 1 ) // barrel
    myMuMuPiMass_barrel->Fill( (*MuMuPiMass)[myB0Idx] - Jp4.M() + mumu_PDGmass ) ;
  ...
  if (nB0AC == 1) {
    ...
    hPionfromB_p_1B0->Fill( Protonp4_orig_1B0.P() ) ;
    hKaonfromB_p_1B0->Fill( Kp4_orig_1B0.P() ) ;
    hPionfromB_pt_1B0->Fill( Protonp4_orig_1B0.Pt() ) ;
    hKaonfromB_pt_1B0->Fill( Kp4_orig_1B0.Pt() ) ;
    kaonP_vs_pionP_1B0->Fill( Protonp4_orig_1B0.P(), Kp4_orig_1B0.P() ) ;
    kaonPt_vs_pionPt_1B0->Fill( Protonp4_orig_1B0.Pt(), Kp4_orig_1B0.Pt() ) ;
    dEdx_vs_p_1B0->Fill( Protonp4_orig_1B0.P(), Proton_dEdx_1B0) ; dEdx_vs_p_1B0->Fill( Kp4_orig_1B0.P(), Kaon_dEdx_1B0) ;
    dEdx_vs_pT_1B0->Fill( Protonp4_orig_1B0.Pt(), Proton_dEdx_1B0) ; dEdx_vs_pT_1B0->Fill( Kp4_orig_1B0.Pt(), Kaon_dEdx_1B0) ;
    //
    // K*
    //
    //cout << "\nbefore K*" <<endl ;		    
    if (B0Mass_2B0[0][0] > 5.25  &&  B0Mass_2B0[0][0] < 5.3) {
      hmyMuMuPiMass->Fill( (PsiPp4_2B0[0][0] + Protonp4_orig_1B0).M() ) ;
      hmyKPiMass->Fill( (Protonp4_orig_1B0 + Kp4_orig_1B0).M() ) ;
      hmyKPiMass_ex->Fill( (Protonp4_orig_ex_1B0 + Kp4_orig_ex_1B0).M() ) ;
      if (Kp4_orig_1B0.Pt() < 1.) {
	hmyKPiMass_KpTcut->Fill( (Protonp4_orig_1B0 + Kp4_orig_1B0).M() ) ;
	hmyKPiMass_ex_KpTcut->Fill( (Protonp4_orig_ex_1B0 + Kp4_orig_ex_1B0).M() ) ;
	// high purity
	if ((*TrackTight)[proton_orig_Idx_1B0] && (*TrackTight)[ka_orig_Idx_1B0]) {

	  hmyKPiMass_KpTcut_tightTr->Fill( (Protonp4_orig_1B0 + Kp4_orig_1B0).M() ) ;
	  hmyKPiMass_ex_KpTcut_tightTr->Fill( (Protonp4_orig_ex_1B0 + Kp4_orig_ex_1B0).M() ) ;
	  if ((*TrackHighPurity)[proton_orig_Idx_1B0] && (*TrackHighPurity)[ka_orig_Idx_1B0]) {

	    hmyKPiMass_KpTcut_HP->Fill( (Protonp4_orig_1B0 + Kp4_orig_1B0).M() ) ;
	    hmyKPiMass_ex_KpTcut_HP->Fill( (Protonp4_orig_ex_1B0 + Kp4_orig_ex_1B0).M() ) ;
	  }
	}
      }
    } // if (B0Mass_2B0[0][0] > 5.25  &&  B0Mass_2B0[0][0] < 5.3)
    ...
    // Armenteros plot
    // original tracks
    TLorentzVector Kstarp4_orig_1B0 = Protonp4_orig_1B0 + Kp4_orig_1B0 ; 
    Float_t pi_KstarPl_orig = ( (Protonp4_orig_1B0.Vect()).Dot(Kstarp4_orig_1B0.Vect()) ) / Kstarp4_orig_1B0.Rho()  ; 
    Float_t K_KstarPl_orig = ( (Kp4_orig_1B0.Vect()).Dot(Kstarp4_orig_1B0.Vect()) ) / Kstarp4_orig_1B0.Rho() ;  
    //Float_t alpha_orig = (pi_KstarPl_orig - K_KstarPl_orig)/(pi_KstarPl_orig + K_KstarPl_orig) ; 
    Float_t pi_KstarPt_orig = sqrt( pow(Protonp4_orig_1B0.Rho(),2) - pow(pi_KstarPl_orig,2) ) ;
    Float_t K_KstarPt_orig = sqrt( pow(Kp4_orig_1B0.Rho(),2) - pow(K_KstarPl_orig,2) ) ;
    // refitted tracks
    TLorentzVector Kstarp4_1B0 = Protonp4_1B0 + Kp4_1B0 ; 
    Float_t pi_KstarPl = ( (Protonp4_1B0.Vect()).Dot(Kstarp4_1B0.Vect()) ) / Kstarp4_1B0.Rho()  ; 
    Float_t K_KstarPl = ( (Kp4_1B0.Vect()).Dot(Kstarp4_1B0.Vect()) ) / Kstarp4_1B0.Rho() ;  
    Float_t alpha = (pi_KstarPl - K_KstarPl)/(pi_KstarPl + K_KstarPl) ; 
    Float_t pi_KstarPt = sqrt( pow(Protonp4_1B0.Rho(),2) - pow(pi_KstarPl,2) ) ;
    //Float_t K_KstarPt = sqrt( pow(Kp4_1B0.Rho(),2) - pow(K_KstarPl,2) ) ;
    // for exchanged particles
    TLorentzVector Kstarp4_orig_ex_1B0 = Protonp4_orig_ex_1B0 + Kp4_orig_ex_1B0 ; 
    Float_t pi_ex_KstarPl = ( (Protonp4_orig_ex_1B0.Vect()).Dot(Kstarp4_orig_ex_1B0.Vect()) ) / Kstarp4_orig_ex_1B0.Rho()  ; 
    Float_t K_ex_KstarPl = ( (Kp4_orig_ex_1B0.Vect()).Dot(Kstarp4_orig_ex_1B0.Vect()) ) / Kstarp4_orig_ex_1B0.Rho() ;  
    //Float_t alpha_orig_ex = (pi_ex_KstarPl - K_ex_KstarPl)/(pi_ex_KstarPl + K_ex_KstarPl) ; 
    Float_t alpha_orig_ex = (K_ex_KstarPl - pi_ex_KstarPl)/(pi_ex_KstarPl + K_ex_KstarPl) ; 
    Float_t pi_ex_KstarPt = sqrt( pow(Protonp4_orig_ex_1B0.Rho(),2) - pow(pi_ex_KstarPl,2) ) ;
    Float_t K_ex_KstarPt = sqrt( pow(Kp4_orig_ex_1B0.Rho(),2) - pow(K_ex_KstarPl,2) ) ;

    if ( (Protonp4_orig_1B0 + Kp4_orig_1B0).M() > Kstar_min  &&  (Protonp4_orig_1B0 + Kp4_orig_1B0).M() < Kstar_max ) { // for right pi-K masses assignment

      hmyPsiPKPiMass_fromKstar->Fill( B0Mass_2B0[0][0] ) ;
      if (B0Mass_2B0[0][0] > hmyPsiPKPiMass_fromKstar->GetXaxis()->GetXmin()  &&  B0Mass_2B0[0][0] < hmyPsiPKPiMass_fromKstar->GetXaxis()->GetXmax()) {
	hmyPsiPKPiMass_fromKstar_ex_noRange->Fill( myB0MassAlt_ex ) ;
	hmyPsiPKPiMass_fromKstar_diff->Fill(B0Mass_2B0[0][0] - myB0MassAlt_ex) ;
      }
      hpsiPK_vs_KPi->Fill( (Protonp4_orig_1B0 + Kp4_orig_1B0).M(), (PsiPp4_2B0[0][0] + Kp4_orig_1B0).M() ) ;
      if ( fabs(B0Mass_2B0[0][0] - 5.280808) < 2*0.00816 ) {
			
	hPionFromKstar_p->Fill( Protonp4_orig_1B0.P() );
	hKaonFromKstar_p->Fill( Kp4_orig_1B0.P() );
	//hPionFromKstar_pT->Fill( pion_fromB0_Pt );
	//hKaonFromKstar_pT->Fill( kaon_fromB0_Pt );
	hPionFromKstar_pT->Fill( Protonp4_orig_1B0.Pt() );
	hKaonFromKstar_pT->Fill( Kp4_orig_1B0.Pt() );
	//
	dEdx_vs_pT_Kstar->Fill( Protonp4_orig_1B0.Pt(), ((*tr_dedx)[proton_orig_Idx_1B0]) ) ; 
	dEdx_vs_pT_Kstar->Fill( Kp4_orig_1B0.Pt(), ((*tr_dedx)[ka_orig_Idx_1B0]) ) ; 
	dEdx_vs_p_Kstar->Fill( Protonp4_orig_1B0.P(), ((*tr_dedx)[proton_orig_Idx_1B0]) ) ; 
	dEdx_vs_p_Kstar->Fill( Kp4_orig_1B0.P(), ((*tr_dedx)[ka_orig_Idx_1B0]) ) ; 
	dEdx_vs_pT_piFromKstar->Fill( Protonp4_orig_1B0.Pt(), ((*tr_dedx)[proton_orig_Idx_1B0]) ) ; 
	dEdx_vs_pT_KFromKstar->Fill( Kp4_orig_1B0.Pt(), ((*tr_dedx)[ka_orig_Idx_1B0]) ) ; 
	dEdx_vs_p_piFromKstar->Fill( Protonp4_orig_1B0.P(), ((*tr_dedx)[proton_orig_Idx_1B0]) ) ; 
	dEdx_vs_p_KFromKstar->Fill( Kp4_orig_1B0.P(), ((*tr_dedx)[ka_orig_Idx_1B0]) ) ; 
	if (Kp4_orig_1B0.P() < 1.) {

	  dEdx_vs_p_piFromKstar_KpCut->Fill( Protonp4_orig_1B0.P(), ((*tr_dedx)[proton_orig_Idx_1B0]) ) ; 
	  dEdx_vs_p_KFromKstar_KpCut->Fill( Kp4_orig_1B0.P(), ((*tr_dedx)[ka_orig_Idx_1B0]) ) ; 
	  if ( Kp4_orig_1B0.P() < 0.8 ) {
	    dEdxK_pCut->Fill( (*tr_dedx)[ka_orig_Idx_1B0] ) ;			  
	    dEdxPi_pCut->Fill( (*tr_dedx)[proton_orig_Idx_1B0] ) ;
	    if ( (*trackShits)[ka_orig_Idx_1B0] >= 17) {
	      dEdxK_pCut_stripCut->Fill( (*tr_dedx)[ka_orig_Idx_1B0] ) ;			  
	      dEdxPi_pCut_stripCut->Fill( (*tr_dedx)[proton_orig_Idx_1B0] ) ;
	    }
	    if ( Kp4_orig_1B0.P() < 0.6) 
	      dEdxK_vs_dEdxPi->Fill((*tr_dedx)[proton_orig_Idx_1B0], (*tr_dedx)[ka_orig_Idx_1B0]) ;
			    
	  }
	}
			
	piFromKstar_stripHits_h->Fill( (*trackShits)[proton_orig_Idx_1B0] ) ;
	piFromKstar_stripHits_vs_y_h->Fill( Protonp4_orig_1B0.Rapidity(), (Float_t)((*trackShits)[proton_orig_Idx_1B0]) ) ;
	KFromKstar_stripHits_h->Fill( (*trackShits)[ka_orig_Idx_1B0] ) ;
	KFromKstar_stripHits_vs_y_h->Fill( Kp4_orig_1B0.Rapidity(), (Float_t)((*trackShits)[ka_orig_Idx_1B0]) ) ;
	if ( (*trackShits)[ka_orig_Idx_1B0] >= 15 ) {
			  
	  dEdx_vs_pT_KhqFromKstar->Fill( Kp4_orig_1B0.Pt(), ((*tr_dedx)[ka_orig_Idx_1B0]) ) ; 
	  dEdx_vs_p_KhqFromKstar->Fill( Kp4_orig_1B0.P(), ((*tr_dedx)[ka_orig_Idx_1B0]) ) ; 
	}
			
	Armenteros_Kstar_orig->Fill(alpha_2B0[0][0], pi_KstarPt_orig) ;
	Armenteros_Kstar->Fill(alpha, pi_KstarPt) ;
	pT_diff->Fill(pi_KstarPt_orig - K_KstarPt_orig) ;
	alpha_vs_alphaEx->Fill(alpha_2B0[0][0], alpha_orig_ex) ;
      } // B0 2*sigma mass window
    } // if ( (Protonp4_orig_1B0 + Kp4_orig_1B0).M() > Kstar_min  &&  (Protonp4_orig_1B0 + Kp4_orig_1B0).M() < Kstar_max ) { //  for right pi-K masses assignment
	      
    else if ( (Protonp4_orig_1B0 + Kp4_orig_1B0).M() < Kstar_lowSB  ||  (Protonp4_orig_1B0 + Kp4_orig_1B0).M() > Kstar_highSB ) { // sideband for right pi-K masses assignment
		
      hmyPsiPKPiMass_fromKstar_sb->Fill( B0Mass_2B0[0][0] ) ;
      hpsiPK_vs_KPi_sb->Fill( (Protonp4_orig_1B0 + Kp4_orig_1B0).M(), (PsiPp4_2B0[0][0] + Kp4_orig_1B0).M()) ;
      if ( fabs(B0Mass_2B0[0][0] - 5.28057) < 2*0.01227 ) {
			
	//hPionFromKstar_sb_pT->Fill( pion_fromB0_Pt );
	//hKaonFromKstar_sb_pT->Fill( kaon_fromB0_Pt );
	hPionFromKstar_sb_pT->Fill( Protonp4_orig_1B0.Pt() );
	hKaonFromKstar_sb_pT->Fill( Kp4_orig_1B0.Pt() );
	//
	Armenteros_Kstar_orig_sb->Fill(alpha_2B0[0][0], pi_KstarPt_orig) ;
	pT_diff_sb->Fill(pi_KstarPt_orig - K_KstarPt_orig) ;
      }		    
    }
    //
    // for exchanged pi-K masses
    if ( (Protonp4_orig_ex_1B0 + Kp4_orig_ex_1B0).M() > Kstar_min  &&  (Protonp4_orig_ex_1B0 + Kp4_orig_ex_1B0).M() < Kstar_max ) {
		      
      hmyPsiPKPiMass_fromKstar_ex->Fill( myB0MassAlt_ex ) ;
      hpsiPK_vs_KPi_ex->Fill( (Protonp4_orig_ex_1B0 + Kp4_orig_ex_1B0).M(), (PsiPp4_2B0[0][0] + Kp4_orig_ex_1B0).M()) ;
	...
	hPionFromKstar_ex_pT->Fill( Protonp4_orig_ex_1B0.Pt() );
	hKaonFromKstar_ex_pT->Fill( Kp4_orig_ex_1B0.Pt() );
	//
	...
	if ( (DeltaR_2B0[0][0] < minDeltaRB0 && DeltaPt_2B0[0][0] < minDeltaPtB0) && (DeltaR_2B0[0][1] < minDeltaRB0 && DeltaPt_2B0[0][1] < minDeltaPtB0) ) {
	  ...
	  for (Int_t i=0; i<nTwins+1; i++) {
		...
		hAlpha_2B0twin[0]->Fill( alpha_2B0[1][i], alpha_2B0[1][1] ) ;
		...
		hAlpha_2B0twin[0]->Fill( alpha_2B0[1][i], alpha_2B0[1][0] ) ;	  
  ...
  if ( (!MC && (nB0AC_signalWin > 0)) || (nB0ACInMC > 0) ) { // nB0ACInMC > 0 only if (MC && nB0AC_signalWin>0) 
	...
	hAlpha_1vs2_2B0twin->Fill( alpha_2B0[1][0], alpha_2B0[1][1] ) ;
	...
	if ( MC )
	  for (Int_t i=0; i<=nTwins_signalWin; i++)
		...
		hAlpha_2B0twin[1]->Fill( alpha_2B0[1][i], alpha_2B0[1][0] ) ;	  
	      ...
	      hAlpha_matchedTwin[0]->Fill( alpha_2B0[1][i] ) ;
	    }
...
void psiPrimePiK_MC::SlaveTerminate()
{
  ...
  if (fOut) 
    {      
      ...
      // HLT_8_Jpsi_v*
      myInclusiveMuMuMass_HLT_8_Jpsi->Write() ;
      // HLT_0_v*
	...
	dEdx_vs_pT[i]->Write() ;
      ...
      hPionfromB_pt->Write() ; hKaonfromB_pt->Write() ;
      exclMuMuKPiMassSel->Write() ; hmyPsiPKPiMass_bothCombSel->Write() ;
      ...
      hB0Mass_noTwins_noSignalWinNotTwins->Write() ; 
      for (Int_t i=0; i<2; i++)
	psi2SPiSqMass_vs_KPiSqMass_1B0[i]->Write() ;
      // pentaQuark
      hB0Mass_1B0->Write() ; hB0CTau_1B0->Write() ;
      hPionfromB_p_1B0->Write() ; hKaonfromB_p_1B0->Write() ;
      hPionfromB_pt_1B0->Write() ; hKaonfromB_pt_1B0->Write() ;
      kaonP_vs_pionP_1B0->Write() ; kaonPt_vs_pionPt_1B0->Write() ;
      dEdx_vs_p_1B0->Write() ; dEdx_vs_pT_1B0->Write() ;
      hB0CTau_1B0matched->Write() ;
      nMCB0_h->Write() ;
	...
	if ( i < 2 )
      ...
      hmyKPiMass->Write() ; hmyKPiMass_ex->Write() ; hmyKPiMass_sb->Write() ; hmyMuMuPiMass->Write() ;
      ...
      hPionFromKstar_p->Write() ; hKaonFromKstar_p->Write() ; hPionFromKstar_pT->Write() ; hKaonFromKstar_pT->Write() ; hPionFromKstar_ex_pT->Write() ; hKaonFromKstar_ex_pT->Write() ; hPionFromKstar_sb_pT->Write() ; hKaonFromKstar_sb_pT->Write() ;
...
void psiPrimePiK_MC::Terminate()
{
  ...
  TString option = GetOption();
  if (option == "officialMC") 
    dir = "officialMC" ; //dir = "officialMC/0p9" ; 
  ...
  if ( (AlexisFile = dynamic_cast<TProofOutputFile*>(fOutput->FindObject("26Jan_histos.root"))) ) {
	...
	//Double_t m_dau1 = kaonCh_mass, m_dau2 = pionCh_mass, m_dau3 = mumu_PDGmass ; 
	Double_t m_dau1 = kaonCh_mass, m_dau2 = pionCh_mass, m_dau3 = mumu_PDGmass ; 
	...
	TString nameReco = "reco_psi2SPi_vs_KPi_dalitz_AC" ;
  ...
  // pentaQuark
  if ( (OutFile = dynamic_cast<TProofOutputFile*>(fOutput->FindObject("pentaQuark.root"))) ) {
    ...
    if (fOut) {
      ...
      //vector< TString > name_TH1I, name_TH1F, name_TH2F ;
      ...
      name_TH.push_back( make_pair("B0_multiplicity_AC_anyMass","TH1I") );
      name_TH.push_back( make_pair("myPsiPMassSel","TH1F") );
      name_TH.push_back( make_pair("myPsiPKPiMassSelAlt","TH1F") );
      name_TH.push_back( make_pair("B0_multiplicity_AC","TH1I") );
      name_TH.push_back( make_pair("B0Mass_1B0","TH1F") );
      name_TH.push_back( make_pair("B0CTau_1B0","TH1F") );
      name_TH.push_back( make_pair("PionfromB_p_1B0","TH1F") );
      name_TH.push_back( make_pair("KaonfromB_p_1B0","TH1F")  );
      name_TH.push_back( make_pair("PionfromB_pT_1B0","TH1F") );
      name_TH.push_back( make_pair("KaonfromB_pT_1B0","TH1F") );
      name_TH.push_back( make_pair("kaonP_vs_pionP_1B0","TH2F") );
      ...
      name_TH.push_back( make_pair("Armenteros_Kstar_orig","TH2F") );
      name_TH.push_back( make_pair("Armenteros_Kstar_orig_ex","TH2F") );
      name_TH.push_back( make_pair("Armenteros_Kstar_orig_sb","TH2F") );

      gStyle->SetOptStat(111111) ;

      /*
      // TH1F
      for (Int_t i = 0; i < abs(name_TH1F.size()); ++i) {
	TH1F* histo = 0;
	if ( (histo = (TH1F*) fOut->Get( name_TH1F[i].Data() )) ) {
	  histo->Draw() ; gPad->SetLogy(0) ;
	  gPad->SaveAs( TString::Format("plots/%s.png", histo->GetName()) );
	} else Warning("Terminate", TString::Format("histogram \"%s\" not found", name_TH1F[i].Data() ));
      }
      // TH1I
      for (Int_t i = 0; i < abs(name_TH1I.size()); ++i) {
	TH1I* histo = 0;
	if ( (histo = (TH1I*) fOut->Get( name_TH1I[i].Data() )) ) {
          histo->Draw("") ;	  
          histo->Draw("text30same") ; gPad->SetLogy() ; 
	  gPad->SaveAs( TString::Format("plots/%s.png", histo->GetName()) );
	} else Warning("Terminate", TString::Format("histogram \"%s\" not found", name_TH1I[i].Data() ));
      }
      // TH2F
      for (Int_t i = 0; i < abs(name_TH2F.size()); ++i) {
	TH2F* histo = 0;
	if ( (histo = (TH2F*) fOut->Get( name_TH2F[i].Data() )) ) {
	  histo->Draw() ;
	  histo->Draw("colz") ; gPad->SetLogy(0) ;
	  gPad->SaveAs( TString::Format("plots/%s.png", histo->GetName()) );
	} else Warning("Terminate", TString::Format("histogram \"%s\" not found", name_TH2F[i].Data() ));
      }
      */
      for (Int_t i = 0; i < abs(name_TH.size()); ++i) {
	TH1I* histo1I = 0; TH1F* histo1F = 0; TH2F* histo2F = 0;
	if ( name_TH[i].second.EqualTo("TH1I") )
	  if ( (histo1I = (TH1I*) fOut->Get( name_TH[i].first.Data() )) ) {
	    histo1I->Draw() ;
	    histo1I->Draw("text30same") ; gPad->SetLogy() ;
	    gPad->SaveAs( TString::Format("plots/%s.png", histo1I->GetName()) );
	  } else Warning("Terminate", TString::Format("histogram \"%s\" not found", name_TH[i].first.Data() )) ;
	else if ( name_TH[i].second.EqualTo("TH1F") )
	  if ( (histo1F = (TH1F*) fOut->Get( name_TH[i].first.Data() )) ) {
	    histo1F->Draw() ; gPad->SetLogy(0) ;
	    gPad->SaveAs( TString::Format("plots/%s.png", histo1F->GetName()) );
	  } else Warning("Terminate", TString::Format("histogram \"%s\" not found", name_TH[i].first.Data() )) ;
    ...
    } else Warning("Terminate", "could not open file: %s", outputFile.Data()) ; 
  }
  else Warning("Terminate", "file \"pentaQuark.root\" not found");
